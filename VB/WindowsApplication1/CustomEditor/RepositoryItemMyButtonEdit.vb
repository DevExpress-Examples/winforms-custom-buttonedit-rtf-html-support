...
Namespace WindowsApplication1
	...
	Public Class RepositoryItemMyButtonEdit
		Inherits RepositoryItemButtonEdit
				Private _RichRI As New RepositoryItemRichTextEdit()
		...
		Public Shared Sub Register()
            EditorRegistrationInfo.Default.Editors.Add(New EditorClassInfo(EditorName, GetType(MyButtonEdit), GetType(RepositoryItemMyButtonEdit), GetType(MyButtonEditViewInfo), New MyPainter(), True))
		End Sub
